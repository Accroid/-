#coding=utf-8
from DB import sql_normal_csldata,sql_normal_csmall,sql_normal_csorder,sql_normal_cspown,sql_normal_cscuser
...
#                          " VALUES ('2018072411392004050001343390', u'吴越欣','RsxeVNONBDbnk63cH2p3hgA7SjTJ8EGl2lzvnOR51U87aK1imH/btOy6OQ0fNA3+k3v/Nh1qevvw\nN2mUAa3rszWRBs0nlJY4aTIsEXHV6vPy60Knwa0oFiLXlRDZwHA0xFBrsPn+qoWDdHY5cIQnJ9E0\nRYMz9hc0HQGkuXR2MO8=','湖北省','仙桃市')")
# print (b2)
b3=myms3.sql_exec("update cso_contract_msg set contractStatus=100 where id in(select a.id from(select id from  cso_contract_msg where gmt_create =(select max(gmt_create)  from  cso_contract_msg))a)")
print (b3)
