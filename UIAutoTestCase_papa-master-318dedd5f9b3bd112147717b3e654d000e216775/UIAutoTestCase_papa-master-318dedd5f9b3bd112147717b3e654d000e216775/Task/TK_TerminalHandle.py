...
from common import  dataprovide, sql_dict,sql_normal,HTMLTestRunner
...
class TerminalHandle(unittest.TestCase):
    timeout=30
    ...
    def setUpClass(cls):
        ...
        desired_caps['deviceName'] = 'd840d812'
        desired_caps['udid'] = 'd840d812'
        # 啪啪钱包的活动名及包名
